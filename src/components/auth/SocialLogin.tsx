  ...
  return (
    <div className="w-full max-w-sm px-5 space-y-4">
      <div className="flex items-center gap-x-3">
        ...
        <span className="text-sm text-muted-foreground shrink-0">o continuar con</span>
        <div className="flex-1 h-px bg-border" />
      </div>

      <div className="grid grid-cols-2 gap-x-2">
        <Button type="button" variant="outline" className="w-full gap-x-3 h-fit rounded-full py-2">
