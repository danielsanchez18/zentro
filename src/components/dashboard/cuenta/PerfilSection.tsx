...
export const PerfilSection = () => {
  ...
  return (
    <div className="flex flex-col w-full lg:pl-5">
      ...
      {/* Nombres completos */}
      <div className="py-5 border-b border-border space-y-2 flex flex-wrap gap-5">
      ...
      {/* Correo electrónico */}
      <div className="py-5 border-b border-border space-y-2 flex flex-wrap items-center justify-between gap-x-5">
      ...
      <div className="pt-5 space-y-2 flex flex-wrap items-center justify-between gap-5 w-full">
        ...
        <Button size="sm" variant="outline" className="text-sm rounded-full h-fit px-4 py-1.5">Editar</Button>
      </div>
