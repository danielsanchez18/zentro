...
El prototipo muestra y permite configurar la prioridad. La detección de solapamientos y la resolución del precio ganador serán responsabilidad del motor de reglas del backend; el frontend consumirá su resultado y mostrará las advertencias devueltas.
